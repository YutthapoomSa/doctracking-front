...
import {reqLogin} from '@services/api/api-login/interfaces/api-login';
...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    isBtnDisabled() {
        if (this.reqLogin.password !== '' && this.reqLogin.password !== null && this.reqLogin.username !== '' && this.reqLogin.username !== null) {
            return false;
        } else {
            return true;
        }
